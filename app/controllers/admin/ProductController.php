...
class ProductController extends AppController
{
    ...
    public function deleteAction()
    {
        if (!empty($_GET)) {
            ...
            $related_product = \R::getCol('SELECT product_id FROM related_product WHERE product_id=?', [$id]);
            $gallery = \R::getCol('SELECT product_id FROM gallery WHERE product_id=?', [$id]);
